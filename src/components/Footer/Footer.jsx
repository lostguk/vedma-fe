		...
		<footer className={styles.footer} id='contacts'>
			<div className={styles.topDecor}>
				<svg viewBox='0 0 1440 60' fill='none' className={styles.wave}>
					<path
						d='M0 30 C360 0 720 60 1080 30 C1260 15 1380 25 1440 30 V60 H0 Z'
						fill='currentColor'
					/>
				</svg>
			</div>
			...
			<div className={`container ${styles.container}`}>
				<div className={styles.top}>
					<div className={styles.brand}>
						...
						<p className={styles.brandDesc}>
							Авторские свечи, зелья и артефакты ручной работы. Магия живёт в
							каждом из нас.
						</p>
						<div className={styles.socials}>
							...
							<a
								href='mailto:info@vedminozelie.ru'
								className={styles.social}
								aria-label='Email'
							>
								<IconMail size={18} />
				...
				<div className={styles.legal}>
					...
					<Link to='/offer' className={styles.legalLink}>
						Публичная оферта
					</Link>
					<span className={styles.legalDot}>&middot;</span>
					<Link to='/returns' className={styles.legalLink}>
						Обмен и возврат
					</Link>
				</div>
				...
				<div className={styles.bottom}>
					<span className={styles.copy}>
						&copy; {new Date().getFullYear()} Ведьмино Зелье. Все права
						защищены.
					</span>
					<div className={styles.madeBlock}>
						<a
							href='http://dev-team.su/'
							className={styles.madeLink}
							target='_blank'
							rel='noopener noreferrer'
						>
							Разработано с
							<IconHeart size={14} className={styles.heartIcon} />и магией -
							row-dev.su
						</a>
					</div>
				</div>
