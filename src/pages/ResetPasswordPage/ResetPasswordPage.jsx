...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true)
    try {
      await resetPassword({ email, token, password, passwordConfirmation: passwordConfirm })
      setSuccess(true)
    } catch (err) {
        ...
        <GlassCard maxWidth={440}>
          {success ? (
            <div className={styles.content}>
              ...
              <p className={styles.text}>Теперь вы можете войти с новым паролем.</p>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.text}>Введите новый пароль для аккаунта {email}</p>
