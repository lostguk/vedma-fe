...
export default function CheckoutDeliverySection({ form, errors, addressError, onAddressChange, onAddressSelect }) {
  return (
    <>
      <section className={styles.section}>
        ...
        <div className={styles.field}>
          <label className={styles.label} htmlFor="co-address">Адрес *</label>
          <AddressInput
            value={form.address}
      ...
      <section className={styles.section}>
        ...
        <div className={styles.deliveryCard}>
          ...
          <p className={styles.deliveryDesc}>
            Отправляем заказанные товары заказной бандеролью или посылкой. Точную стоимость рассчитаем после
            сборки заказа и сообщим на email или по телефону.
          </p>
        </div>
      </section>
    </>
