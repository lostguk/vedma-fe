	...
	return (
		<section className={styles.section}>
			...
			{!isAuthenticated && (
				<>
					<p className={styles.sectionHint}>
						Войдите или заполните поля ниже — мы создадим аккаунт при оформлении
						заказа.
					</p>
					<div className={styles.fieldGrid3}>
						<div className={styles.field}>
							<label className={styles.label} htmlFor='co-lastname'>
								Фамилия *
							</label>
							<input
								id='co-lastname'
						...
						<div className={styles.field}>
							<label className={styles.label} htmlFor='co-firstname'>
								Имя *
							</label>
							<input
								id='co-firstname'
						...
						<div className={styles.field}>
							<label className={styles.label} htmlFor='co-middlename'>
								Отчество
							</label>
							<input
								id='co-middlename'
			...
			{!isAuthenticated && (
				<div className={styles.fieldGrid2}>
					<div className={styles.field}>
						<label className={styles.label} htmlFor='co-pass'>
							Пароль *
						</label>
						<PasswordInput
							id='co-pass'
					...
					<div className={styles.field}>
						<label className={styles.label} htmlFor='co-pass2'>
							Подтвердите пароль *
						</label>
						<PasswordInput
							id='co-pass2'
							className={errors.passwordConfirm ? styles.inputError : undefined}
			...
			>
				...
				<span className={styles.consentText}>
					...
					,{' '}
					<Link to='/offer' className={styles.consentLink}>
						Публичной офертой
					</Link>{' '}
